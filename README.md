...
🎓 Graduated with **Excellent Honors** from **École Polytechnique de Tunisie**
...
- 🧠 **LLMs & Agentic Systems** — structured prompting, RAG, multi-agent orchestration, guardrails
- 👁️ **Computer Vision** — multimodal pipelines, fine-tuning vision foundation models (CLIP)
- 🎯 **Reinforcement Learning** — exploring RLHF & policy optimization
- ⚙️ **MLOps & Cloud** — GCP (Vertex AI, BigQuery), reproducible pipelines, monitoring & traceability
...
![Agentic AI](https://img.shields.io/badge/Agentic%20AI-8A2BE2?style=flat&logo=bot&logoColor=white)
![MCP](https://img.shields.io/badge/MCP-6B4EFF?style=flat&logo=protocolsdotio&logoColor=white)
![Groq](https://img.shields.io/badge/Groq-F55036?style=flat&logo=groq&logoColor=white)
![Ollama](https://img.shields.io/badge/Ollama-000000?style=flat&logo=ollama&logoColor=white)
![Fine-Tuning](https://img.shields.io/badge/Fine--Tuning-FF6F61?style=flat&logo=huggingface&logoColor=white)
![Prompt Engineering](https://img.shields.io/badge/Prompt%20Engineering-16A085?style=flat&logo=openai&logoColor=white)
...
![LightGBM](https://img.shields.io/badge/LightGBM-3B7A57?style=flat&logo=leaflet&logoColor=white)
![XGBoost](https://img.shields.io/badge/XGBoost-EB6E4B?style=flat&logo=xgboost&logoColor=white)
![CLIP](https://img.shields.io/badge/CLIP-000000?style=flat&logo=openai&logoColor=white)

### 📈 Time Series, Forecasting & Clustering
![Time Series](https://img.shields.io/badge/Time%20Series-1E90FF?style=flat&logo=chartdotjs&logoColor=white)
...
### 🗄️ Databases, Vector DBs & Backend
...
*Curious, adaptable, and driven by continuous learning — always exploring new AI technologies.* 🚀
